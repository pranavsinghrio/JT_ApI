...
public abstract class AbstractBuilder {
    ...
    public com.justransform.jaxws.AbstractBuilder cxfInInterceptors(Interceptor<? extends Message> ... interceptors) {
     ...
     */
    @SuppressWarnings("unchecked")
    public com.justransform.jaxws.AbstractBuilder cxfInFaultInterceptors(Interceptor<? extends Message> ... interceptors) {
     ...
     */
    @SuppressWarnings("unchecked")
    public com.justransform.jaxws.AbstractBuilder cxfOutInterceptors(Interceptor<? extends Message> ... interceptors) {
     ...
     */
    @SuppressWarnings("unchecked")
    public com.justransform.jaxws.AbstractBuilder cxfOutFaultInterceptors(Interceptor<? extends Message> ... interceptors) {
     ...
     * @return
     */
    public com.justransform.jaxws.AbstractBuilder enableMtom() {
